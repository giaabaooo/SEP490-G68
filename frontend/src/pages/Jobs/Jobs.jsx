      ...
      <div className="max-w-6xl mx-auto px-4 -mt-12 relative z-20 flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 space-y-4">
          ...
          {loading ? (
            ...
            jobs.map((job) => (
              <Link to={`/jobs/${job._id || job.id}`} key={job._id || job.id} className="block bg-white rounded-2xl p-6 shadow-sm border border-slate-200 hover:border-emerald-400 hover:shadow-md transition-all group relative">
                ...
                <div className="flex flex-col md:flex-row gap-5">
                  ...
                  <div className="flex flex-row md:flex-col items-center md:items-end justify-between md:justify-start mt-4 md:mt-0 border-t md:border-t-0 pt-4 md:pt-0 border-slate-100">
                    <button className="text-slate-300 hover:text-emerald-600 transition-colors mb-auto hidden md:block"><Bookmark className="w-5 h-5" /></button>
