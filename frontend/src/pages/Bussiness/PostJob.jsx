    ...
    <div className="animate-fade-in pb-12">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
        <div>
          ...
          <p className="text-black text-sm font-medium">Theo dõi tin đăng và các bài test đánh giá năng lực ứng viên.</p>
        </div>
              ...
              {filteredJobs.map((job) => {
                ...
                return (
                  <tr key={job._id || job.id} className="border-b border-slate-50 last:border-0 hover:bg-slate-50/80 transition-colors">
                    ...
                    <td className="p-5 font-medium text-black">{job.salary || 'Thỏa thuận'}</td>
