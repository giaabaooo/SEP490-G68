                            ...
                            <div className="flex gap-1 items-center">
                              {status === 'Testing' && app.testStatus === 'Completed' && (
                                <button 
                                  ...
                                  className="px-2 py-1 bg-blue-50 text-blue-600 rounded-lg text-[11px] font-black hover:bg-blue-600 hover:text-white transition-colors cursor-pointer border border-blue-100" 
