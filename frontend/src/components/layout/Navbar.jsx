...
const Navbar = () => {
  ...
  // Logic xác định link khi bấm vào Logo
  const getHomeLink = () => {
      ...
      <header className="top-navbar">
        ...
        <div className="nav-center" style={{ display: 'flex', gap: '30px', height: '100%' }}>
          ...
          {role === 'business' && subRole === 'moderator' && (
             <>
               <div className="nav-item-dropdown">
                 <NavLink to="/moderator/requests" className={({ isActive }) => isActive ? "nav-link-item active" : "nav-link-item"}>Yêu cầu Test</NavLink>
               </div>
               <div className="nav-item-dropdown">
            ...
            <>
              ...
              <div className="nav-item-dropdown">
                ...
                <div className="dropdown-menu-content mega-menu">
                  {/* ... Code Dropdown Mega Menu Candidate giữ nguyên ... */}
