...
const Navbar = () => {
  ...
  const handleNotificationClick = async (n) => {
    ...
    // Xử lý thông báo Yêu cầu tạo bài Test chuyên môn mới của Moderator -> Nhảy vào chi tiết JD
    if (n.type === 'moderator_request' || (n.title && n.title.includes('Yêu cầu tạo bài Test'))) {
      ...
      // Trích xuất tên Job trong thông báo dạng: cho vị trí "gg" từ ...
  ...
  const getHomeLink = () => {
    ...
    if (role === 'business') {
      return subRole === 'moderator' ? '/moderator/requests' : '/bussiness/dashboard';
    }
    return '/home';
  };
              ...
              <div className="dropdown-menu-content" style={{ width: '280px' }}>
                ...
                <div className="menu-section" style={{ paddingBottom: '16px' }}>
                  <div className="dropdown-item has-icon logout" onClick={handleLogout} style={{ justifyContent: 'center', background: '#f8fafc', margin: '0 16px', borderRadius: '8px', border: '1px solid #e2e8f0', padding: '10px' }}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" /><polyline points="16 17 21 12 16 7" /><line x1="21" y1="12" x2="9" y2="12" /></svg>Đăng xuất
                  </div>
                </div>
